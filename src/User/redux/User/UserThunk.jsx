...
export const UserAddRatingProduct = createAsyncThunk(
  "user/addRating",
  async ({ formData, toast }, { rejectWithValue }) => {
    try {
      // Replace with the correct API endpoint for adding a rating
      const response = await axios.post("/api/addrating", formData);
...
export const AverageRatingFetchApi = createAsyncThunk(
  "product/fetchAverageRating",
  async ({ toast, productId }, { rejectWithValue }) => {
    try {
      const response = await axios.get(`/api/product/${productId}/average`);
      ...
      return response.data; // Returning the average rating data
    } catch (error) {
      toast.error(
...
export const getRatingsForProductThunk = createAsyncThunk(
  "ratings/fetchRatings",
  async ({ productId }, { rejectWithValue }) => {
    try {
      const response = await axios.get(`/api/product/${productId}`); // API endpoint
