...
getContactsFetchApi,
UserAddRatingProduct,
AverageRatingFetchApi,
getRatingsForProductThunk,
} from "./UserThunk"
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getContactsFetchApi.pending, (state) => {
        ...
        .addCase(UserAddRatingProduct.pending, (state) => {
          state.loading = true;
        })
        .addCase(UserAddRatingProduct.fulfilled, (state, action) => {
          state.loading = false;
          state.ratingResponse = action.payload;
          state.error = null;
        })
        .addCase(UserAddRatingProduct.rejected, (state, action) => {
          state.loading = false;
          state.error = action.payload;
        })
    
    
        .addCase(AverageRatingFetchApi.pending, (state) => {
          state.loading = true;
          state.error = null;
        })
        .addCase(AverageRatingFetchApi.fulfilled, (state, action) => {
          state.loading = false;
          state.ratingData = action.payload; // Update the state with fetched data
        })
        .addCase(AverageRatingFetchApi.rejected, (state, action) => {
          state.loading = false;
        ...
        .addCase(getRatingsForProductThunk.pending, (state) => {
          state.loading = true;
          state.error = null;
        })
        .addCase(getRatingsForProductThunk.fulfilled, (state, action) => {
          state.loading = false;
          state.ratings = action.payload; // Update state with fetched ratings
        })
        .addCase(getRatingsForProductThunk.rejected, (state, action) => {
          state.loading = false;
          state.error = action.payload; // Capture error message
        });
